...
Just add JPEGs to an "Images" folder just --highlight-style=tango outside of the slideCarouselSimple.php file --. The carousel requires PHP5 or higher to be loaded on its hosting server. I wrote this in Javascript, PHP, and HTML5 so it can be mobile and or desktop compatible... Enjoy!
